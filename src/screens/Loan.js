    ...
    render() {
        return(
            ...
            <View style={styles.container}>
                <Text style={{textAlign:'center', fontSize: 18, paddingTop:20, color:'#2F4F4F',}}>Books are the most loyal and trusted friends you can ever have</Text>
                <TextInput style={styles.inputBox} underlineColorAndroid='rgba(0,0,0,0)' placeholder={item.title}
